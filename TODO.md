...
- Add a "remix" button where you can change the active cards
- Add storage of the active cards in local storage
- Add a deck-list feature where you save your deck to local storage
